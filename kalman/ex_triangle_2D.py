...
for t in time:
    ...
    #print(" v2_rel [0]: ", v2_relative[0:2])
    #print("\n")
    ...
    print(" xyz rel : ", q2.xyz - q1.xyz)
    print("\n")
    # distance sensor!
    distance_1_to_2 = kf.distance(q2.xyz[0]-q1.xyz[0], q2.xyz[1]-q1.xyz[1])
    print(" distance_1_to_2 ", distance_1_to_2)
    print("\n")
    distance_1_to_3 = kf.distance(q3.xyz[0]-q1.xyz[0], q3.xyz[1]-q1.xyz[1])
    # the drone 1 estimates the position of drone 2 and 3
    # for drone 2 pos estimation in plane XY

    kf.predict(v2_relative[0:2].transpose())
    kf.update(distance_1_to_2)

    # for drone 3 pos est. in plane XY

   # kf.predict(v3_relative[0:2])
   # kf.update(distance_1_to_3)
    ...
    if it%frames == 0:
        ...
        kf.animation(it,tf,time,err_log)
