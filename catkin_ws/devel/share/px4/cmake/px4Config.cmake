...
if("TRUE" STREQUAL "TRUE")
  set(px4_SOURCE_PREFIX /home/jalop17/01-scripts/drone-swarm/src/Firmware)
  set(px4_DEVEL_PREFIX /home/jalop17/01-scripts/drone-swarm/devel)
  set(px4_INSTALL_PREFIX "")
  set(px4_PREFIX ${px4_DEVEL_PREFIX})
else()
  set(px4_SOURCE_PREFIX "")
  set(px4_DEVEL_PREFIX "")
  set(px4_INSTALL_PREFIX /home/jalop17/01-scripts/drone-swarm/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jalop17/01-scripts/drone-swarm/src/Firmware/${idir}'.  ${_report}")
    endif()
